 ...
 */
final class Version20220207081903 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE study CHANGE location location VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
